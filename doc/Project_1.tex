...
\section{\large The repuslive interaction}
    ...
    There is a decrease in the onebody density as a result of the repuslive interaction.
    It worth mentioning that runnung this calculation repeatedly gives slightly different results, however the overall result that the onebody density is higher without the repulse interaction stays prominent, although how much it changes from run to run varies.
