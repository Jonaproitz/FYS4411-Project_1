...
\section{\large Analytic expressions}
    ...
    \subsection*{Onebody densities}
        ...
        \end{equation}
        Defining the new vector $\mathbf{u} = \mathbf{r}_2 - \mathbf{r}_1$
        \begin{equation}
                \rho(\mathbf{r}_1)
...
\section{\large The repuslive interaction}
    ...
    \begin{table}[!ht]
        ...
        Without repulsive interaction   & 0.478737              \\ \hline
        With repulsive interaction      & 0.000987037           \\ \hline
        \end{tabular}
        \caption{}
        \label{results 3}
    \end{table}
    ...
    There is a clear decrease in the onebody density as a result of the repuslive interaction.
