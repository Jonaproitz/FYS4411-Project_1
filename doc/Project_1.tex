...
\section{\large The repuslive interaction}
    ...
    It worth mentioning that runnung this calculation repeatedly gives slightly different results, however the overall result that the onebody density is higher without the repulse interaction stays prominent though how much changes from run to run.
